...
public class Hms   {
  ...
  public void login() throws Exception {
	        ...
	        driver.findElement(By.name("username")).sendKeys("dgdg");
	        driver.findElement(By.name("password")).sendKeys("sfsff");
  ...
  public void registation() throws Exception {
	    ...
	    // new Select(driver.findElement(By.name("DOB"))).selectByVisibleText("20-08-1996");
	     ...
	     driver.findElement(By.name("image")).sendKeys("C:\\Users\\91991\\Pictures\\Camera Roll\\WIN_20191117_16_56_53_Pro.jpg");
	     driver.findElement(By.name("submit")).click();
	     Thread.sleep(3000);
  ...
  @BeforeClass
  public void oprnurl() throws Exception {
